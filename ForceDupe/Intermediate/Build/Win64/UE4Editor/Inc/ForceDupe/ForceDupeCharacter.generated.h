...
#ifdef FORCEDUPE_ForceDupeCharacter_generated_h
#error "ForceDupeCharacter.generated.h already included, missing '#pragma once' in ForceDupeCharacter.h"
#endif
...
public: \
	DECLARE_CLASS(AForceDupeCharacter, ACharacter, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ForceDupe"), NO_API) \
...
#define ForceDupe_Source_ForceDupe_ForceDupeCharacter_h_16_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AForceDupeCharacter); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AForceDupeCharacter); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AForceDupeCharacter(AForceDupeCharacter&&); \
	NO_API AForceDupeCharacter(const AForceDupeCharacter&); \
public:
...
#define ForceDupe_Source_ForceDupe_ForceDupeCharacter_h_16_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__VR_Gun() { return STRUCT_OFFSET(AForceDupeCharacter, VR_Gun); } \
	FORCEINLINE static uint32 __PPO__VR_MuzzleLocation() { return STRUCT_OFFSET(AForceDupeCharacter, VR_MuzzleLocation); } \
	FORCEINLINE static uint32 __PPO__FirstPersonCameraComponent() { return STRUCT_OFFSET(AForceDupeCharacter, FirstPersonCameraComponent); } \
	FORCEINLINE static uint32 __PPO__R_MotionController() { return STRUCT_OFFSET(AForceDupeCharacter, R_MotionController); } \
...
template<> FORCEDUPE_API UClass* StaticClass<class AForceDupeCharacter>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID ForceDupe_Source_ForceDupe_ForceDupeCharacter_h
